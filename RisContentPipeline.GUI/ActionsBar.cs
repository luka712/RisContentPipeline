...
internal class ActionsBar
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ActionsBar"/> class.
    /// </summary>
    /// <param name="parentWindow">The parent window for dialogs.</param>
    public ActionsBar(Window parentWindow, Context context)
    {
        _context = context;
